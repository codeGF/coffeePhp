...
class Excel
{
	 ...
	 */
         ...
         * checks the type of variable and returns the specific field setting
         * for the cell.
         *
...
# 例子:
#实例化
$xls = new Excel_XML ( 'UTF-8', false, 'My Test Sheet' ); #实例化
#标题数组(二维)
$data = array(
...
$xls->addArray ( $content );  #调用内容方法
$xls->generateXML ( 'test' );  #文件名
*/