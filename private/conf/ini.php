...
$conf["SYSTEM_MAX_EXECUTION_TIME"] = SYSTEM_MAX_EXECUTION_TIME; //php最大运行时间设置
$conf["SYSTEM_TIMEZONE_SET"] = "Asia/Shanghai"; //时区设置
$conf["SYSTEM_TIME"] = isset($_SERVER["REQUEST_TIME_FLOAT"]) ? $_SERVER["REQUEST_TIME_FLOAT"] : $_SERVER["REQUEST_TIME"]; //初始化全局时间
...
$conf["SYSTEM_SEND_HEADER"] = true; //是否发送框架定义头信息
...
//应用配置文件设置
$conf["APP_REGISTRY_CONF"] = $conf["APP_CONFIG_PATH"] . "/system/registry.php"; //框架注册表配置文件路径
$conf["APP_DB_CONF"] = $conf["APP_CONFIG_PATH"] . "/system/db.php"; //数据库配置文件路径
$conf["APP_CACHE_CONF"] = $conf["APP_CONFIG_PATH"] . "/system/cache.php"; //缓存配置文件路径
...
ini_set("max_execution_time", $conf["SYSTEM_MAX_EXECUTION_TIME"]); //设置运行时间
